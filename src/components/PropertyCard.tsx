...
function PropertyCard({property}: PropertyCardProps) {
    ...
    return (
        <div
            className="relative rounded-lg overflow-hidden border border-gray-200 hover:shadow-lg transition-shadow bg-white">
            <label
                className="absolute top-2 left-2 z-10 bg-white/90 rounded px-2 py-1 flex items-center gap-1 text-xs font-medium cursor-pointer">
                <input
                    type="checkbox"
                    checked={isSelected}
